...
df = pd.get_dummies(df, columns=['NEIGHBORHOOD', 'BUILDING CLASS CATEGORY', 'BUILDING CLASS AT TIME OF SALE'])
...
df = df.drop(columns=['#','BOROUGH','BLOCK', 'YEAR BUILT', 'current_year'])
